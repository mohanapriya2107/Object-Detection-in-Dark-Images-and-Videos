...
def predict_img():
    if request.method=="POST":
        ...
        img="C:\\Users\\hp\\Downloads\\human_detection\\static\\uploads\\"+secure_filename(f.filename)
...
def predict_video():
    if request.method=="POST":
        ...
        video_path="C:\\Users\\hp\\Downloads\\human_detection\\static\\uploads\\"+secure_filename(f.filename)
